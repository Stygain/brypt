...
%The devices used for this network as nodes will be Adafruit Featherboards, while Raspberry Pi computers will act as network coordinators.
%We chose these devices because they have differing architectures and capabilities, and so will better simulate an actual IoT network: 
%the Featherboards will be chosen from BLE, LoRa, and ARM Cortex Wi-Fi and ESP-8266 Wi-Fi.
